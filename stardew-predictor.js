...
window.onload = function () {
    ...
    if (save.hasOwnProperty(prop)) {
      ...
      if (type === "text" || type === "string") {
        ...
        try {
          ...
          $("#results-note").html(
            "Ignoring invalid URL parameter for gameID: " +
              $.QueryString[queryProp] +
  ...
  function parseSummary(xmlDoc) {
    ...
    save.furniture = {
      ...
      _800: {
        id: "800",
        name: "Winter Dining Table",
        price: 3500,
        offlimits: false,
      },
      _807: {
        id: "807",
        name: "Festive Dining Table",
        price: 3500,
        offlimits: false,
      },
      _814: {
      ...
      _1301: {
        id: "1301",
        name: "Sloth Skeleton L",
        price: 500,
        offlimits: true,
      },
      _1302: {
        id: "1302",
        name: "Sloth Skeleton M",
        price: 500,
        offlimits: true,
      },
      _1303: {
        id: "1303",
        name: "Sloth Skeleton R",
        price: 500,
        offlimits: true,
      },
      ...
      _1306: {
        id: "1306",
        name: "Leah's Sculpture",
        price: 500,
        offlimits: true,
      },
      _1307: {
        id: "1307",
        name: "Dried Sunflowers",
        price: 500,
        offlimits: true,
      },
      ...
      _1376: {
        id: "1376",
        name: "House Plant (1376)",
        price: 250,
        offlimits: false,
      },
      _1377: {
        id: "1377",
        name: "House Plant (1377)",
        price: 250,
        offlimits: false,
      },
      _1378: {
        id: "1378",
        name: "House Plant (1378)",
        price: 250,
        offlimits: false,
      },
      _1379: {
        id: "1379",
        name: "House Plant (1379)",
        price: 250,
        offlimits: false,
      },
      _1380: {
        id: "1380",
        name: "House Plant (1380)",
        price: 250,
        offlimits: false,
      },
      _1381: {
        id: "1381",
        name: "House Plant (1381)",
        price: 250,
        offlimits: false,
      },
      _1382: {
        id: "1382",
        name: "House Plant (1382)",
        price: 250,
        offlimits: false,
      },
      _1383: {
        id: "1383",
        name: "House Plant (1383)",
        price: 250,
        offlimits: false,
      },
      _1384: {
        id: "1384",
        name: "House Plant (1384)",
        price: 250,
        offlimits: false,
      },
      _1385: {
        id: "1385",
        name: "House Plant (1385)",
        price: 250,
        offlimits: false,
      },
      _1386: {
        id: "1386",
        name: "House Plant (1386)",
        price: 250,
        offlimits: false,
      },
      _1387: {
        id: "1387",
        name: "House Plant (1387)",
        price: 250,
        offlimits: false,
      },
      _1388: {
        id: "1388",
        name: "House Plant (1388)",
        price: 250,
        offlimits: false,
      },
      _1389: {
        id: "1389",
        name: "House Plant (1389)",
        price: 250,
        offlimits: false,
      },
      _1390: {
        id: "1390",
        name: "House Plant (1390)",
        price: 250,
        offlimits: false,
      },
      _1391: {
      ...
      _1796: {
        id: "1796",
        name: "Iridium Fireplace",
        price: 15000,
        offlimits: true,
      },
      _1798: {
        id: "1798",
        name: "Stove Fireplace",
        price: 3000,
        offlimits: true,
      },
      _1800: {
      ...
      _1915: {
        id: "1915",
        name: "Night Sky Decal #2",
        price: 750,
        offlimits: true,
      },
      _1916: {
        id: "1916",
        name: "Night Sky Decal #3",
        price: 750,
        offlimits: true,
      },
      _1952: {
      ...
      _1959: {
        id: "1959",
        name: "'It Howls In The Rain'",
        price: 400,
        offlimits: true,
      },
      _1960: {
        id: "1960",
        name: "Indoor Hanging Basket",
        price: 400,
        offlimits: true,
      },
      _1961: {
        id: "1961",
        name: "Winter Tree Decal",
        price: 400,
        offlimits: true,
      },
      _1760: {
        id: "1760",
        name: "Small Junimo Plush",
        price: 1500,
        offlimits: true,
      },
      _1761: {
      ...
      _1375: {
        id: "1375",
        name: "Purple Serpent Statue",
        price: 500,
        offlimits: true,
      },
      _1471: {
        id: "1471",
        name: "Green Serpent Statue",
        price: 500,
        offlimits: true,
      },
      ...
      _2058: {
        id: "2058",
        name: "Starry Double Bed",
        price: 5000,
        offlimits: true,
      },
      _2064: {
        id: "2064",
        name: "Strawberry Double Bed",
        price: 5000,
        offlimits: true,
      },
      _2070: {
        id: "2070",
        name: "Pirate Double Bed",
        price: 5000,
        offlimits: true,
      },
      ...
      _2637: {
        id: "2637",
        name: "Floor Divider R",
        price: 50,
        offlimits: false,
      },
      _2638: {
        id: "2638",
        name: "Floor Divider L",
        price: 50,
        offlimits: false,
      },
      _2639: {
      ...
      _2584: {
        id: "2584",
        name: "'Jade Hills Extended'",
        price: 6750,
        offlimits: false,
      },
      _2720: {
        id: "2720",
        name: "Large Brown Couch",
        price: 5750,
        offlimits: false,
      },
      _2784: {
      ...
      _DecorativeBarrel: {
        id: "DecorativeBarrel",
        name: "Decorative Barrel",
        price: 500,
        offlimits: false,
      },
      _MountedTrout_Painting: {
        id: "MountedTrout_Painting",
        name: "Mounted Trout",
        price: 500,
        offlimits: true,
      },
      _SquidKid_Painting: {
        id: "SquidKid_Painting",
        name: "'Squid Kid'",
        price: 500,
        offlimits: true,
      },
      ...
      _BluePinstripeDoubleBed: {
        id: "BluePinstripeDoubleBed",
        name: "Blue Pinstripe Double Bed",
        price: 500,
        offlimits: true,
      },
      _JojaBed: {
      ...
      _JojaColaPainting: {
        id: "JojaColaPainting",
        name: "Joja Cola Painting",
        price: 999,
        offlimits: true,
      },
      _JojaColaOrnament: {
        id: "JojaColaOrnament",
        name: "Joja Cola Ornament",
        price: 999,
        offlimits: true,
      },
      _JojaFireplace: {
      ...
      _StackedJojaCrates: {
        id: "StackedJojaCrates",
        name: "Stacked Joja Boxes",
        price: 999,
        offlimits: true,
      },
      _JojaCouch: {
      ...
      _JojaShoppingCart: {
        id: "JojaShoppingCart",
        name: "Joja Shopping Cart",
        price: 999,
        offlimits: true,
      },
      _LargeJojaCrate: {
        id: "LargeJojaCrate",
        name: "Large Joja Crate",
        price: 999,
        offlimits: true,
      },
      _JojaColaFridge: {
        id: "JojaColaFridge",
        name: "Joja Cola Fridge",
        price: 999,
        offlimits: true,
      },
      _JojaDresser: {
      ...
      _JojaCoffeeTable: {
        id: "JojaCoffeeTable",
        name: "Joja Coffee Table",
        price: 999,
        offlimits: true,
      },
      _GrayJojaCoffeeTable: {
        id: "GrayJojaCoffeeTable",
        name: "Gray Joja Coffee Table",
        price: 999,
        offlimits: true,
      },
      _JojaLamp: {
      ...
      _DecorativeJojaDoor: {
        id: "DecorativeJojaDoor",
        name: "Decorative Joja Door",
        price: 999,
        offlimits: true,
      },
      _WizardBed: {
      ...
      _LargeWizardBookcase: {
        id: "LargeWizardBookcase",
        name: "Large Wizard Bookcase",
        price: 999,
        offlimits: true,
      },
      _WizardBookcase: {
        id: "WizardBookcase",
        name: "Wizard Bookcase",
        price: 999,
        offlimits: true,
      },
      _ShortWizardBookcase: {
        id: "ShortWizardBookcase",
        name: "Short Wizard Bookcase",
        price: 999,
        offlimits: true,
      },
      _SmallWizardBookcase: {
        id: "SmallWizardBookcase",
        name: "Small Wizard Bookcase",
        price: 999,
        offlimits: true,
      },
      _WizardStool: {
      ...
      _SmallStackedElixirShelf: {
        id: "SmallStackedElixirShelf",
        name: "Small Stacked Elixir Shelf",
        price: 999,
        offlimits: true,
      },
      _StackedElixirShelf: {
        id: "StackedElixirShelf",
        name: "Stacked Elixir Shelf",
        price: 999,
        offlimits: true,
      },
      _ElixirBundle: {
      ...
      _AmethystCrystalBall: {
        id: "AmethystCrystalBall",
      ...
      _TopazCrystalBall: {
        id: "TopazCrystalBall",
        name: "Topaz Crystal Ball",
        price: 999,
        offlimits: true,
      },
      _AquamarineCrystalBall: {
        id: "AquamarineCrystalBall",
        name: "Aquamarine Crystal Ball",
        price: 999,
        offlimits: true,
      },
      _EmeraldCrystalBall: {
        id: "EmeraldCrystalBall",
        name: "Emerald Crystal Ball",
        price: 999,
        offlimits: true,
      },
      _RubyCrystalBall: {
        id: "RubyCrystalBall",
        name: "Ruby Crystal Ball",
        price: 999,
        offlimits: true,
      },
      _SmallBookStack: {
        id: "SmallBookStack",
        name: "Small Book Stack",
        price: 999,
        offlimits: true,
      },
      _BookStack: {
      ...
      _FallenPurpleBook: {
        id: "FallenPurpleBook",
        name: "Fallen Purple Book",
        price: 999,
        offlimits: true,
      },
      _FallenBlueBook: {
        id: "FallenBlueBook",
        name: "Fallen Blue Book",
        price: 999,
        offlimits: true,
      },
      _FallenYellowBook: {
        id: "FallenYellowBook",
        name: "Fallen Yellow Book",
        price: 999,
        offlimits: true,
      },
      _FallenRedBook: {
        id: "FallenRedBook",
        name: "Fallen Red Book",
        price: 999,
        offlimits: true,
      },
      _FallenGreenBook: {
        id: "FallenGreenBook",
        name: "Fallen Green Book",
        price: 999,
        offlimits: true,
      },
      _FallenBrownBook: {
        id: "FallenBrownBook",
        name: "Fallen Brown Book",
        price: 999,
        offlimits: true,
      },
      _SmallBookPile: {
      ...
      _LargeBookPile: {
        id: "LargeBookPile",
        name: "Large Book Pile",
        price: 999,
        offlimits: true,
      },
      _DecorativeWizardDoor: {
        id: "DecorativeWizardDoor",
        name: "Decorative Wizard Door",
        price: 999,
        offlimits: true,
      },
      _JunimoBed: {
      ...
      _LargeJunimoHut: {
        id: "LargeJunimoHut",
        name: "Large Junimo Hut",
        price: 999,
        offlimits: true,
      },
      _SmallJunimoHut: {
        id: "SmallJunimoHut",
        name: "Small Junimo Hut",
        price: 999,
        offlimits: true,
      },
      _JunimoFireplace: {
        id: "JunimoFireplace",
        name: "Junimo Fireplace",
        price: 999,
        offlimits: true,
      },
      _JunimoBookcase: {
        id: "JunimoBookcase",
        name: "Junimo Bookcase",
        price: 999,
        offlimits: true,
      },
      _JunimoPot: {
      ...
      _GreenSleepingJunimo: {
        id: "GreenSleepingJunimo",
        name: "Green Sleeping Junimo",
        price: 999,
        offlimits: true,
      },
      _BlueSleepingJunimo: {
        id: "BlueSleepingJunimo",
        name: "Blue Sleeping Junimo",
        price: 999,
        offlimits: true,
      },
      _RedSleepingJunimo: {
        id: "RedSleepingJunimo",
        name: "Red Sleeping Junimo",
        price: 999,
        offlimits: true,
      },
      _PurpleSleepingJunimo: {
        id: "PurpleSleepingJunimo",
        name: "Purple Sleeping Junimo",
        price: 999,
        offlimits: true,
      },
      _YellowSleepingJunimo: {
        id: "YellowSleepingJunimo",
        name: "Yellow Sleeping Junimo",
        price: 999,
        offlimits: true,
      },
      _OrangeSleepingJunimo: {
        id: "OrangeSleepingJunimo",
        name: "Orange Sleeping Junimo",
        price: 999,
        offlimits: true,
      },
      _GraySleepingJunimo: {
        id: "GraySleepingJunimo",
        name: "Gray Sleeping Junimo",
        price: 999,
        offlimits: true,
      },
      _SquareJunimoRug: {
      ...
      _ElliottPortrait: {
        id: "ElliottPortrait",
        name: "Elliott Portrait",
        price: 999,
        offlimits: true,
      },
      _HarveyPortrait: {
        id: "HarveyPortrait",
        name: "Harvey Portrait",
        price: 999,
        offlimits: true,
      },
      _SamPortrait: {
      ...
      _SebastianPortrait: {
        id: "SebastianPortrait",
        name: "Sebastian Portrait",
        price: 999,
        offlimits: true,
      },
      _ShanePortrait: {
      ...
      _BrochureCabinet: {
        id: "BrochureCabinet",
        name: "Brochure Cabinet",
        price: 999,
        offlimits: true,
      },
      _LeafyWallPanel: {
        id: "LeafyWallPanel",
        name: "Leafy Wall Panel",
        price: 999,
        offlimits: true,
      },
      _LightLeafyWallPanel: {
        id: "LightLeafyWallPanel",
        name: "Light Leafy Wall Panel",
        price: 999,
        offlimits: true,
      },
      _DarkLeafyWallPanel: {
        id: "DarkLeafyWallPanel",
        name: "Dark Leafy Wall Panel",
        price: 999,
        offlimits: true,
      },
      _DecorativeJunimoDoor: {
        id: "DecorativeJunimoDoor",
        name: "Decorative Junimo Door",
        price: 999,
        offlimits: true,
      },
      _RetroBed: {
      ...
      _DecorativeRetroDoor: {
        id: "DecorativeRetroDoor",
        name: "Decorative Retro Door",
        price: 999,
        offlimits: true,
      },
      _DecorativeDoor1: {
      ...
      _DecorativeHatch: {
        id: "DecorativeHatch",
        name: "Decorative Hatch",
        price: 1000,
        offlimits: false,
      },
      _DecorativeOakLadder: {
        id: "DecorativeOakLadder",
        name: "Decorative Oak Ladder",
        price: 2500,
        offlimits: false,
      },
      _DecorativeWalnutLadder: {
        id: "DecorativeWalnutLadder",
        name: "Decorative Walnut Ladder",
        price: 2500,
        offlimits: false,
      },
      _UprightPiano: {
      ...
      _OakLampEndTable: {
        id: "OakLampEndTable",
        name: "Oak Lamp End Table",
        price: 2000,
        offlimits: false,
      },
      _WalnutLampEndTable: {
        id: "WalnutLampEndTable",
        name: "Walnut Lamp End Table",
        price: 2000,
        offlimits: false,
      },
      _BirchLampEndTable: {
        id: "BirchLampEndTable",
        name: "Birch Lamp End Table",
        price: 2000,
        offlimits: false,
      },
      _MahoganyLampEndTable: {
        id: "MahoganyLampEndTable",
        name: "Mahogany Lamp End Table",
        price: 3000,
        offlimits: false,
      },
      _TriangleWindow: {
      ...
      _BountifulDiningTable: {
        id: "BountifulDiningTable",
        name: "Bountiful Dining Table",
        price: 10000,
        offlimits: false,
      },
      _PlasticLawnEndTable: {
        id: "PlasticLawnEndTable",
        name: "Plastic Lawn End Table",
        price: 999,
        offlimits: true,
      },
      _PlasticLawnChair: {
      ...
      _FancyHousePlant3: {
        id: "FancyHousePlant3",
        name: "House Plant (FancyHousePlant3)",
        price: 250,
        offlimits: true,
      },
      _FancyHousePlant1: {
        id: "FancyHousePlant1",
        name: "House Plant (FancyHousePlant1)",
        price: 250,
        offlimits: true,
      },
      _FancyHousePlant2: {
        id: "FancyHousePlant2",
        name: "House Plant (FancyHousePlant2)",
        price: 250,
        offlimits: true,
      },
      _FancyHousePlant4: {
        id: "FancyHousePlant4",
        name: "House Plant (FancyHousePlant4)",
        price: 250,
        offlimits: true,
      },
      _FancyHousePlant5: {
        id: "FancyHousePlant5",
        name: "House Plant (FancyHousePlant5)",
        price: 250,
        offlimits: true,
      },
      _PigPainting: {
      ...
      _MidnightBeachDoubleBed: {
        id: "MidnightBeachDoubleBed",
    ...
    save.shirts = {
      ...
      _1008: {
        id: "1008",
        name: "Good Grief Shirt",
        price: 50,
        offlimits: false,
      },
      _1009: {
        id: "1009",
        name: "Aquamarine Shirt",
        price: 50,
        offlimits: false,
      },
      ...
      _1011: {
        id: "1011",
        name: "Green Belted Shirt",
        price: 50,
        offlimits: false,
      },
      _1012: {
        id: "1012",
        name: "Lime Green Striped Shirt",
        price: 50,
        offlimits: false,
      },
      _1013: {
      ...
      _1016: {
        id: "1016",
        name: "Night Sky Shirt",
        price: 50,
        offlimits: false,
      },
      _1017: {
        id: "1017",
        name: "Mayoral Suspenders",
        price: 50,
        offlimits: false,
      },
      ...
      _1132: {
        id: "1132",
        name: "Crop Tank Top (M)",
        price: 50,
        offlimits: false,
      },
      _1133: {
        id: "1133",
        name: "Crop Tank Top (F)",
        price: 50,
        offlimits: false,
      },
      ...
      _1176: {
        id: "1176",
        name: "Basic Pullover (M)",
        price: 50,
        offlimits: false,
      },
      _1177: {
        id: "1177",
        name: "Basic Pullover (F)",
        price: 50,
        offlimits: false,
      },
      _1178: {
      ...
      _1179: {
        id: "1179",
        name: "Iridium Energy Shirt",
        price: 50,
        offlimits: false,
      },
      _1180: {
        id: "1180",
        name: "Tunnelers Jersey",
        price: 50,
        offlimits: false,
      },
      ...
      _1227: {
        id: "1227",
        name: "Antiquity Shirt",
        price: 50,
        offlimits: false,
      },
      _1228: {
        id: "1228",
        name: "Soft Arrow Shirt",
        price: 50,
        offlimits: false,
      },
      ...
      _1262: {
        id: "1262",
        name: "Dark Bandana Shirt",
        price: 50,
        offlimits: false,
      },
      _1263: {
        id: "1263",
        name: "Dark Highlight Shirt",
        price: 50,
        offlimits: false,
      },
      ...
      _1269: {
        id: "1269",
        name: "Pour-Over Shirt",
        price: 50,
        offlimits: false,
      },
      _1270: {
        id: "1270",
        name: "Green Jacket Shirt",
        price: 50,
        offlimits: false,
      },
      ...
      _1280: {
        id: "1280",
        name: "Red Buttoned Vest",
        price: 50,
        offlimits: false,
      },
      _1281: {
        id: "1281",
        name: "Green Buttoned Vest",
        price: 50,
        offlimits: false,
      },
      ...
      _1285: {
        id: "1285",
        name: "Midnight Dog Jacket",
        price: 50,
        offlimits: false,
      },
      _1286: {
        id: "1286",
        name: "Shrimp Enthusiast Shirt",
        price: 50,
        offlimits: false,
      },
    ...
    if (typeof xmlDoc !== "undefined") {
      ...
      save.visitsUntilY1Guarantee = Number(
        $(xmlDoc).find("SaveGame > visitsUntilY1Guarantee").text(),
      );
      save.farmName =
      ...
      if (compareSemVer(save.version, "1.6") >= 0) {
        ...
        var geodesCracked = 0,
          ...
          trashCansChecked = 0;
        $(xmlDoc)
          .find("SaveGame > player > stats > Values > item")
          .each(function () {
        ...
        $(xmlDoc)
          ...
          .each(function () {
            ...
            if (name !== "" || user !== "") {
              ...
              save.mp_ids.push(
                bigInt($(this).find("UniqueMultiplayerID").text()),
              );
              $(this)
                .find("stats > Values > item")
                .each(function () {
                  var key = $(this).find("key > string").text();
                  var value = $(this).find("value > *").text();
                  if (key === "geodesCracked") {
        ...
        ((save.timesFedRaccoons = Number(
          $(xmlDoc).find("SaveGame > timesFedRaccoons").text(),
        )),
          (save.useLegacyRandom =
            $(xmlDoc).find("useLegacyRandom").text() === "true"));
        ...
        save.geodesCracked.push(
          Number(
            $(xmlDoc).find("SaveGame > player > stats > geodesCracked").text(),
          ),
        );
        $(xmlDoc)
          .find("farmhand")
          .each(function () {
            ...
            save.gender.push(
              $(this).find("isMale").first().text() == "true"
                ? "Male"
                : "Female",
            );
            save.mp_ids.push(
            ...
            save.geodesCracked.push(
              Number($(this).find("stats > geodesCracked").text()),
            );
          });
        save.daysPlayed = Number(
          $(xmlDoc).find("stats > daysPlayed").first().text(),
        );
        ...
        if (compareSemVer(save.version, "1.4") >= 0) {
          var timesEnchanted = 0,
            trashCansChecked = 0;
          $(xmlDoc)
            .find("SaveGame > player > stats > stat_dictionary > item")
            .each(function () {
              var key = $(this).find("key > string").text();
              if (key === "timesEnchanted") {
                timesEnchanted = Number(
                  $(this).find("value > unsignedInt").text(),
                );
              } else if (key === "trashCansChecked") {
                trashCansChecked = Number(
                  $(this).find("value > unsignedInt").text(),
                );
              }
            });
          ...
          $(xmlDoc)
            ...
            .each(function () {
              ...
              trashCansChecked = 0;
              $(this)
                .find("stats > stat_dictionary > item")
                .each(function () {
                  var key = $(this).find("key > string").text();
                  if (key === "timesEnchanted") {
                    timesEnchanted = Number(
        ...
        save.geodesCracked.push(
          Number($(xmlDoc).find("SaveGame > stats > geodesCracked").text()),
        );
        save.daysPlayed = Number(
          $(xmlDoc).find("stats > daysPlayed").first().text(),
        );
      ...
      if (save.trashCansChecked.length === 0) {
        save.trashCansChecked.push(0);
      }
      if (save.timesEnchanted.length === 0) {
        save.timesEnchanted.push(0);
      }
      if (save.mysteryBoxesOpened.length === 0) {
        save.mysteryBoxesOpened.push(0);
      }
      ...
      save.niceDate =
        "Day " +
        Number($(xmlDoc).find("SaveGame > dayOfMonth").text()) +
        " of " +
        capitalize($(xmlDoc).find("SaveGame > currentSeason").html()) +
        ", Year " +
        save.year;
      if (compareSemVer(save.version, "1.5") >= 0) {
        save.hardmodeMines =
          Number($(xmlDoc).find("SaveGame > minesDifficulty").text()) > 0;
      }
      save.deepestMineLevel = Number(
        $(xmlDoc).find("player > deepestMineLevel").text(),
      );
      ...
      $(xmlDoc)
        .find("player > craftingRecipes > item")
        .each(function () {
            ...
            .each(function () {
              $(this)
                ...
                .each(function () {
                  ...
                  if (
                    ignore.hasOwnProperty(type) ||
                    ignore.hasOwnProperty(who)
                  ) {
                    return true;
                  }
                  if (who === "Leo") {
      ...
      if (compareSemVer(save.version, "1.5") >= 0) {
        ...
        $(xmlDoc)
          .find("SaveGame > specialOrders > SpecialOrder")
          .each(function () {
    ...
    wasChanged.dayAdjust = overrideSaveData(
      "dayAdjust",
      "dayAdjust",
      "da",
      "int",
    );
    wasChanged.daysPlayed = overrideSaveData(
      "daysPlayed",
      "daysPlayed",
      "dp",
      "int",
    ...
    wasChanged.geodesCracked = overrideSaveData(
      "geodesCracked",
      "geodesCracked",
      "gc",
      "array",
    );
    wasChanged.mysteryBoxesOpened = overrideSaveData(
      "mysteryBoxesOpened",
      "mysteryBoxesOpened",
      "mb",
      "array",
    );
    wasChanged.ticketPrizesClaimed = overrideSaveData(
      "ticketPrizesClaimed",
      "ticketPrizesClaimed",
      "pt",
      "array",
    );
    wasChanged.timesEnchanted = overrideSaveData(
      "timesEnchanted",
      "timesEnchanted",
      "te",
      "array",
    );
    wasChanged.trashCansChecked = overrideSaveData(
      "trashCansChecked",
      "trashCansChecked",
      "tc",
      "array",
    );
    wasChanged.deepestMineLevel = overrideSaveData(
      "deepestMineLevel",
      "deepestMineLevel",
      "dml",
      "int",
    );
    wasChanged.timesFedRaccoons = overrideSaveData(
      "timesFedRaccoons",
      "timesFedRaccoons",
      "tfr",
      "int",
    );
    wasChanged.visitsUntilY1Guarantee = overrideSaveData(
      "visitsUntilY1Guarantee",
      "visitsUntilY1Guarantee",
      "vg",
      "int",
    );
    wasChanged.dailyLuck = overrideSaveData(
      "dailyLuck",
      "dailyLuck",
      "dl",
      "num",
    );
    wasChanged.luckLevel = overrideSaveData(
      "luckLevel",
      "luckLevel",
      "ll",
      "int",
    );
    wasChanged.canHaveChildren = overrideSaveData(
      "canHaveChildren",
      "canHaveChildren",
      "chc",
      "bool",
    );
    wasChanged.quarryUnlocked = overrideSaveData(
      "quarryUnlocked",
      "quarryUnlocked",
      "qu",
      "bool",
    );
    wasChanged.desertUnlocked = overrideSaveData(
      "desertUnlocked",
      "desertUnlocked",
      "du",
      "bool",
    );
    wasChanged.greenhouseUnlocked = overrideSaveData(
      "greenhouseUnlocked",
      "greenhouseUnlocked",
      "gu",
      "bool",
    );
    wasChanged.hasFurnaceRecipe = overrideSaveData(
      "hasFurnaceRecipe",
      "hasFurnaceRecipe",
      "hfr",
      "bool",
    );
    wasChanged.hasSpecialCharm = overrideSaveData(
      "hasSpecialCharm",
      "hasSpecialCharm",
      "hsc",
      "bool",
    );
    wasChanged.leoMoved = overrideSaveData(
      "leoMoved",
      "leoMoved",
      "leo",
      "bool",
    );
    wasChanged.hasGarbageBook = overrideSaveData(
      "hasGarbageBook",
      "hasGarbageBook",
      "hgb",
      "bool",
    );
    wasChanged.gotMysteryBook = overrideSaveData(
      "gotMysteryBook",
      "gotMysteryBook",
      "gmb",
      "bool",
    );
    wasChanged.hardmodeMines = overrideSaveData(
      "hardmodeMines",
      "hardmodeMines",
      "hm",
      "bool",
    );
    wasChanged.useLegacyRandom = overrideSaveData(
      "useLegacyRandom",
      "useLegacyRandom",
      "leg",
      "bool",
    );
    wasChanged.theaterUnlocked = overrideSaveData(
      "theaterUnlocked",
      "theaterUnlocked",
      "tu",
      "bool",
    );
    wasChanged.ccComplete = overrideSaveData(
      "ccComplete",
      "ccComplete",
      "cc",
      "bool",
    );
    wasChanged.jojaComplete = overrideSaveData(
      "jojaComplete",
      "jojaComplete",
      "jc",
      "bool",
    );
    wasChanged.qiCropsActive = overrideSaveData(
      "qiCropsActive",
      "qiCropsActive",
      "qc",
      "bool",
    ...
    if (save.visitsUntilY1Guarantee >= 0) {
      ...
      save.originalGuarantee =
        save.visitsUntilY1Guarantee +
        Math.floor(dayOfSave / 7) +
        Math.floor((dayOfSave + 2) / 7);
      if (dayOfSave >= 99) {
        save.originalGuarantee++;
      }
      if (dayOfSave >= 100) {
    ...
    output +=
      '<h3>Save State Summary</h3><p>Important information taken from the save file which is needed for predictions. Anything that was overridden by <a href="#advanced_usage">a URL parameter</a> is marked with an asterisk (*).</p>';
    output += '<table class="summary table table-striped"><tr><td>';
    output +=
      '<span class="result">' +
      (wasChanged.gameID ? "*" : "") +
      "Game ID: " +
    ...
    output +=
      ...
      save.version +
      "</span><br/>";
    if (save.names.length === 0) {
      save.names[0] = "Unknown Farmer";
    }
    output +=
      '<span class="result">Farmer ' +
      save.names[0] +
      " of " +
      save.farmName +
      "</span><br/>";
    if (save.names.length > 1) {
      output +=
        '<span class="result">Farmhands: ' +
        save.names.slice(1).join(", ") +
        "</span><br/>";
    }
    if (save.niceDate !== "") {
      output +=
      ...
      output +=
        '<span class="result">' +
        (wasChanged.daysPlayed || wasChanged.dayAdjust ? "*" : "") +
        (save.daysPlayed + save.dayAdjust) +
        " days played</span><br/>\n";
    }
    output +=
      '<span class="result">' +
      (wasChanged.geodesCracked ? "*" : "") +
      "Geodes cracked: ";
    ...
    if (compareSemVer(save.version, "1.6") >= 0) {
      ...
      output +=
        '<span class="result">' +
        (wasChanged.ticketPrizesClaimed ? "*" : "") +
        "Prize Tickets claimed: ";
      for (var i = 0; i < save.names.length; i++) {
    ...
    output +=
      '<span class="result">' +
      (wasChanged.deepestMineLevel ? "*" : "") +
      "Deepest mine level: " +
      Math.min(120, save.deepestMineLevel) +
      "</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.timesFedRaccoons ? "*" : "") +
      "Times fed raccoons: " +
      save.timesFedRaccoons +
      "</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.visitsUntilY1Guarantee ? "*" : "") +
      "Cart Y1 Guarantee: ";
    if (save.visitsUntilY1Guarantee >= 0) {
    ...
    output +=
      '<span class="result">' +
      (wasChanged.dailyLuck ? "*" : "") +
      "Daily Luck is assumed to be " +
      save.dailyLuck;
    ...
    output +=
      '<span class="result">' +
      (wasChanged.luckLevel ? "*" : "") +
      "Luck buffs are assumed to be " +
      save.luckLevel +
      "</span><br/>";
    output += "</td><td>";
    ...
    output +=
      '<span class="result">' +
      (wasChanged.useLegacyRandom ? "*" : "") +
      "Legacy RNG Seeding is " +
      (save.useLegacyRandom ? "on" : "off") +
      "</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.quarryUnlocked ? "*" : "") +
      "Quarry is " +
      (save.quarryUnlocked ? "" : "not") +
      " unlocked</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.desertUnlocked ? "*" : "") +
      "Desert is " +
      (save.desertUnlocked ? "" : "not") +
      " unlocked</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.greenhouseUnlocked ? "*" : "") +
      "Greenhouse is " +
      (save.greenhouseUnlocked ? "" : "not") +
      " unlocked</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.ccComplete ? "*" : "") +
      "Community Center is " +
      (save.ccComplete ? "" : "not") +
      " complete</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.jojaComplete ? "*" : "") +
      "Joja Community Development is " +
      (save.jojaComplete ? "" : "not") +
      " complete</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.theaterUnlocked ? "*" : "") +
      "Theater is " +
      (save.theaterUnlocked ? "" : "not") +
      " unlocked</span><br/>";
    if (compareSemVer(save.version, "1.3") < 0) {
      output +=
        '<span class="result">' +
        (wasChanged.canHaveChildren ? "*" : "") +
        "Farmer can" +
        (save.canHaveChildren ? "" : "not") +
        " have more children</span><br/>";
    }
    output +=
      '<span class="result">' +
      (wasChanged.hasFurnaceRecipe ? "*" : "") +
      "Farmer " +
      (save.hasFurnaceRecipe ? "has" : "does not have") +
      " furnace recipe</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.hasSpecialCharm ? "*" : "") +
      "Farmer " +
      (save.hasSpecialCharm ? "has" : "does not have") +
      " special luck charm</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.hasGarbageBook ? "*" : "") +
      "Farmer has " +
      (save.hasGarbageBook ? "" : "not") +
      ' read <span class="book">The Alleyway Buffet</span></span><br/>';
    output +=
      '<span class="result">' +
      (wasChanged.gotMysteryBook ? "*" : "") +
      "Farmer has " +
      (save.gotMysteryBook ? "" : "not") +
    ...
    output +=
      '<span class="result">' +
      (wasChanged.hardmodeMines ? "*" : "") +
      "Mines are " +
      (save.hardmodeMines ? "" : "not") +
      " currently hard difficulty</span><br/>";
    output +=
      '<span class="result">' +
      (wasChanged.qiCropsActive ? "*" : "") +
      "Qi Crops special order is " +
      (save.qiCropsActive ? "" : "not") +
      " active</span><br/>";
    output += "</td></tr></table>";
    return output;
  }
      ...
      for (weekDay = 1; weekDay < 8; weekDay++) {
        ...
        if (compareSemVer(save.version, "1.4") < 0) {
          for (mineLevel = 1; mineLevel < 120; mineLevel++) {
            ...
            rng = new CSRandom(
              day + save.dayAdjust + mineLevel + save.gameID / 2,
            );
            if (
              mineLevel % 40 > 5 &&
              mineLevel % 40 < 30 &&
          ...
          for (mineLevel = 1; mineLevel < 120; mineLevel++) {
            ...
            if (compareSemVer(save.version, "1.6") < 0) {
              rng = new CSRandom(
                day + save.dayAdjust + mineLevel * 100 + save.gameID / 2,
              );
            } else {
              rng = new CSRandom(
                getRandomSeed(
            ...
            if (
              ...
              if (
                rng.NextDouble() < 0.25 &&
                compareSemVer(save.version, "1.5") < 0
              ) {
        ...
        var mushroomText =
          '<img src="blank.png" class="small-icon" alt="Mushroom" id="icon_m">&nbsp;';
        if (rainbowLights.length === 0) {
          mushroomText = '<span class="none">' + mushroomText + "None</span>";
        } else {
          if (rainbowLights.length > 5) {
            mushroomText =
              '<span data-tooltip="All results: ' +
              rainbowLights +
              '">' +
              mushroomText +
              rainbowLights.slice(0, 4).join(",&nbsp;") +
              ",...</span>";
          } else {
        ...
        var infestedText =
          '<img src="blank.png" class="small-icon" alt="Sword" id="icon_i">&nbsp;';
        if (infestedMonster.length === 0) {
          ...
          if (infestedMonster.length > 5) {
            infestedText =
              ...
              '">' +
              infestedText +
              infestedMonster.slice(0, 4).join(",&nbsp;") +
              ",...</span>";
          } else {
        ...
        var slimeText =
          '<img src="blank.png" class="small-icon" alt="Slime" id="icon_s">&nbsp;';
        ...
        var quarryText =
          '<img src="blank.png" class="small-icon" alt="Skull" id="icon_q">&nbsp;';
        ...
        if (dinoLevel.length === 0) {
          ...
          if (dinoLevel.length > 5) {
            dinoText =
              '<span data-tooltip="All results (level 1-500): ' +
              dinoLevel +
              '">' +
              dinoText +
              dinoLevel.slice(0, 4).join(",&nbsp;") +
              ",...</span>";
          } else {
  ...
  function predictTrash(isSearch, offset) {
    ...
    if (compareSemVer(save.version, "1.6") >= 0 && save.hasGarbageBook) {
      luckCheck += 0.2;
    }
    for (week = 0; week < 4; week++) {
      output += "<tr>";
        ...
        for (whichCan = 0; whichCan < 8; whichCan++) {
          if (compareSemVer(save.version, "1.6") >= 0) {
            seed = getRandomSeed(
              day + save.dayAdjust,
              save.gameID / 2,
              777 + getHashFromString(canID[whichCan]),
            );
          } else {
          ...
          if (compareSemVer(save.version, "1.6") >= 0) {
            ...
            if (save.trashCansChecked[0] >= 20 && rng.NextDouble() < 0.002) {
              ...
              save.trashCansChecked[0] >= 50 &&
              rng.NextDouble() < 0.002
            ) {
              doubleMega = true;
                ...
                switch (whichCan) {
                  case 4:
                    if (rng.NextDouble() < 0.2 + save.dailyLuck) {
                      switch (rng.Next(3)) {
                        case 0:
                          trashItem = wikify("Copper Ore");
                          break;
                        case 1:
                          trashItem = wikify("Iron Ore");
                          break;
                        case 2:
                          trashItem = wikify("Coal");
                          break;
                      }
                  ...
                  case 6:
                    ...
                    break;
                  case 7:
                    rngSynced = new CSRandom(
                      getRandomSeed(
                        getHashFromString("garbage_joja"),
                        save.gameID,
                        day + save.dayAdjust,
                      ),
                    );
                  ...
                  case 3:
                    rngSynced = new CSRandom(
                      getRandomSeed(
                        getHashFromString("garbage_museum_535"),
                        save.gameID,
                        day + save.dayAdjust,
                      ),
                    );
                    if (rngSynced.NextDouble() < 0.2 + save.dailyLuck) {
                      rngSynced = new CSRandom(
                        getRandomSeed(
                          getHashFromString("garbage_museum_749"),
                          save.gameID,
                          day + save.dayAdjust,
                        ),
                      );
                  ...
                  case 5:
                    rngSynced = new CSRandom(
                      getRandomSeed(
                        getHashFromString("garbage_saloon_dish"),
                        save.gameID,
                        day + save.dayAdjust,
                      ),
                    );
                    if (rngSynced.NextDouble() < 0.2 + save.dailyLuck) {
                      trashItem =
                        '<a href="https://stardewvalleywiki.com/The_Stardrop_Saloon#Rotating_Stock">Dish of the Day</a>';
                    }
                    break;
                }
              }
            ...
            doubleMega =
              save.trashCansChecked[0] >= 20 && rng.NextDouble() < 0.002
                ? true
                : false;
            if (doubleMega) {
              trashItem = wikify("Garbage Hat");
              ...
              switch (rng.Next(10)) {
                case 0:
                  trashItem = wikify("Trash (item)");
                  break;
                case 1:
                  trashItem = wikify("Joja Cola");
                  break;
                case 2:
                  trashItem = wikify("Broken Glasses");
                  break;
                case 3:
                  trashItem = wikify("Broken CD");
                  break;
                case 4:
                  trashItem = wikify("Soggy Newspaper");
                  break;
                case 5:
                  trashItem = wikify("Bread");
                  break;
                case 6:
                  //trashItem = wikify(getSeasonalItem(whichCan, month % 4, day)); break;
                  var rngSeason = new CSRandom(
                    save.gameID +
                      day +
                      save.dayAdjust +
                      tileX[whichCan] * 653 +
                  ...
                  trashItem = wikify(
                    getRandomItemFromSeason(rngSeason, month % 4),
                  );
                  break;
                case 7:
                  trashItem = wikify("Field Snack");
                  break;
                case 8:
                  switch (rng.Next(3)) {
                    case 0:
                      trashItem = wikify("Acorn");
                      break;
                    case 1:
                      trashItem = wikify("Maple Seed");
                      break;
                    case 2:
                      trashItem = wikify("Pine Cone");
                      break;
                  }
                  break;
                case 9:
                  trashItem = wikify("Green Algae");
                  break;
              }
  ...
  function predictWallpaper(isSearch, offset) {
    ...
    year = 1 + Math.floor(offset / 112);
    output +=
      '<table class="output"><thead><tr><th class="day">Date</th>' +
    ...
    for (weekDay = 1; weekDay < 8; weekDay++) {
      ...
      output +=
        ...
        '">';
      output += showPierre
        ? '<div class="wp"><img src="blank.png" class="wp left" id="wp_' +
          wp_p +
          '"><img src="blank.png" class="wp right" id="wp_' +
          wp_p +
          '"> ' +
          "Wallpaper #" +
          wp_p +
          ...
          eq_p +
          "<br/></div><br/>" +
          '<div class="fl"><img src="blank.png" class="fl" id="fl_' +
          fl_p +
          '"> ' +
          "Floor # " +
          fl_p +
  ...
  function predictCart(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      searchStart = $("#cart-search-all").prop("checked")
        ? 0
        : 7 * Math.floor((save.daysPlayed - 1) / 7);
      searchEnd = 112 * $("#cart-search-range").val();
      output +=
        '<table class="output"><thead><tr><th colspan="4">Search results for &quot;' +
        offset +
        "&quot; over the " +
        ($("#cart-search-all").prop("checked") ? "first " : "next ") +
        $("#cart-search-range").val() +
        " year(s)</th></tr>\n";
      output +=
        '<tr><th class="day">Day</th><th class="item">Item</th><th class="qty">Qty</th><th class="price">Price</th></tr>\n<tbody>';
      count = 0;
      ...
      for (
        ...
        for (var i = 0; i < days.length; i++) {
          ...
          rngFirst = new CSRandom(
            save.gameID + offset + days[i] + save.dayAdjust,
          );
      ...
      output +=
        '<tr><td colspan="4" class="count">Found ' +
        count +
        " matching item(s)</td></tr></tbody></table>\n";
    } else {
      ...
      output +=
        '<table class="output"><thead><tr><th rowspan="2">' +
        (isNightMarket ? "Night Market<br/>Boat" : "Forest Cart") +
        "</th>";
      output +=
        '<th colspan="3" class="multi">' +
        save.dayNames[startDay] +
        " " +
        monthName +
        " " +
        (dayOfMonth + 5) +
      ...
      output +=
        ...
        "</th></tr>\n";
      output +=
        '<tr><th class="item">Item</th><th class="qty">Qty</th><th class="price">Price</th>';
      if (isNightMarket) {
        output +=
          '<th class="item">Item</th><th class="qty">Qty</th><th class="price">Price</th>';
      }
      output +=
      ...
      price = rngFirst.Next(1, 11) * 250;
      output +=
        '<tr><td>Furniture</td><td class="item">' +
        wikify(item, "Furniture") +
        "</td><td>1</td><td>" +
        addCommas(price) +
        "g</td>";
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      for (
        ...
        for (var i = 0; i < days.length; i++) {
          ...
          dayOfMonth = (offset % 28) + days[i];
          dayOfWeek = save.dayNames[days[i] - 1];
          var rng = new CSRandom(
            getRandomSeed(offset + days[i] + save.dayAdjust, save.gameID / 2),
          );
          var rngSynced;
          var pick = getRandomItems(
            rng,
            "objects",
            2,
            789,
          ...
          for (var slot = 0; slot < 10; slot++) {
            price = Math.max(
              rng.Next(1, 11) * 100,
              rng.Next(3, 6) * save.objects[pick[slot]].price,
            );
            ...
            if (searchTerm.test(save.objects[pick[slot]].name)) {
              ...
              output +=
                ...
                year +
                "</td><td>" +
                wikify(save.objects[pick[slot]].name) +
                "</td><td>" +
                qty +
                "</td><td>" +
                addCommas(price) +
          ...
          if (save.originalGuarantee >= 0) {
            ...
            var visitsNow =
              save.originalGuarantee -
              Math.floor(dayOfPrediction / 7) -
              Math.floor((dayOfPrediction + 2) / 7);
            if (dayOfPrediction >= 99) {
              visitsNow--;
            }
            if (dayOfPrediction >= 100) {
              visitsNow--;
            }
            if (dayOfPrediction >= 101) {
              visitsNow--;
            }
            if (visitsNow == 0) {
              ...
              price = Math.max(
                rng.Next(1, 11) * 100,
                rng.Next(3, 6) * save.objects["_485"].price,
              );
              qty = rng.NextDouble() < 0.1 ? 5 : 1;
          ...
          if (month % 4 < 2) {
            ...
            rngSynced = new CSRandom(
              getRandomSeed(
                getHashFromString("cart_rarecrow"),
                save.gameID,
                offset + days[i] + save.dayAdjust,
              ),
            );
          ...
          if (month % 4 > 1) {
            rngSynced = new CSRandom(
              getRandomSeed(
                getHashFromString("cart_coffee_bean"),
                save.gameID,
                offset + days[i] + save.dayAdjust,
              ),
            );
          ...
          if (save.ccComplete || save.jojaComplete) {
            rngSynced = new CSRandom(
              getRandomSeed(
                getHashFromString("cart_jojaCatalogue"),
                save.gameID,
                offset + days[i] + save.dayAdjust,
              ),
            );
            ...
            rngSynced = new CSRandom(
              getRandomSeed(
                getHashFromString("cart_junimoCatalogue"),
                save.gameID,
                offset + days[i] + save.dayAdjust,
              ),
            );
          ...
          rngSynced = new CSRandom(
            getRandomSeed(
              getHashFromString("cart_retroCatalogue"),
              save.gameID,
              offset + days[i] + save.dayAdjust,
            ),
          );
          ...
          name = "Tea Set";
          if (
            rngSynced.NextDouble() < 0.1 &&
            searchTerm.test(name) &&
            offset + save.dayAdjust >= 2688
          ) {
            price = 1000000;
            qty = 1;
            count++;
      ...
      if (dayOfYear === 94 || dayOfYear === 10) {
        ...
        cartName =
          dayOfYear === 94
            ? "Night Market<br/>Boat"
            : "Desert Festival<br/>Cart";
      } else {
        days = [5, 7];
        $("#cart-next-week").val(offset + 7);
        $("#cart-prev-week").val(offset - 7);
      ...
      for (var d = 0; d < days.length; d++) {
        output +=
          '<th colspan="3" class="multi">' +
          save.dayNames[days[d] - nameOffset] +
          " " +
          monthName +
          " " +
          (dayOfMonth + days[d]) +
      ...
      for (var d = 0; d < days.length; d++) {
        cart[d] = {};
        cart[d].rng = new CSRandom(
          getRandomSeed(offset + days[d] + save.dayAdjust, save.gameID / 2),
        );
        ...
        for (var slot = 1; slot <= 10; slot++) {
          ...
          cart[d].selectedItems[slot].price = Math.max(
            cart[d].rng.Next(1, 11) * 100,
            cart[d].rng.Next(3, 6) * save.objects[pick[slot - 1]].price,
          );
          cart[d].selectedItems[slot].qty =
            cart[d].rng.NextDouble() < 0.1 ? 5 : 1;
        }
      }
      for (var slot = 1; slot <= 10; slot++) {
        output += "<tr><td>Basic Item " + slot + "</td>";
        for (var d = 0; d < days.length; d++) {
          output +=
            '<td class="item">' +
            wikify(cart[d].selectedItems[slot].name) +
            "</td><td>" +
            cart[d].selectedItems[slot].qty +
            "</td><td>" +
            addCommas(cart[d].selectedItems[slot].price) +
            "g</td>";
        }
        output += "</tr>";
      }
      ...
      if (save.originalGuarantee >= 0) {
        ...
        for (var d = 0; d < days.length; d++) {
          ...
          if (visitsNow == 0) {
            ...
            price = Math.max(
              cart[d].rng.Next(1, 11) * 100,
              cart[d].rng.Next(3, 6) * save.objects["_485"].price,
            );
            ...
            output +=
              '<td class="item">(' +
              visitsNow +
              (visitsNow == 1 ? " visit" : " visits") +
              " left)</td><td>--</td><td>--</td>";
          } else {
            output +=
              '<td class="item">(Already passed)</td><td>--</td><td>--</td>';
          }
        }
        output += "</tr>";
      }
      ...
      if (month % 4 < 2) {
        ...
        for (var d = 0; d < days.length; d++) {
          var rngSynced = new CSRandom(
            getRandomSeed(
              getHashFromString("cart_rarecrow"),
              save.gameID,
              offset + days[d] + save.dayAdjust,
            ),
          );
      ...
      if (month % 4 > 1) {
        ...
        output +=
          '<td class="item note" colspan="' +
          span +
          '">Only possible in Fall or Winter</td>';
      }
      output += "</tr>";
      ...
      if (save.ccComplete) {
        ...
        output +=
          '<td class="item note" colspan="' +
          span +
          '">Only possible after Community Center Restoration</td>';
      }
      output += "</tr>";
      ...
      if (offset + save.dayAdjust >= 2688) {
        ...
        output +=
          '<td class="item note" colspan="' +
          span +
          '">Only possible in Year 25 or later</td>';
      }
      output += "</tr>";
      ...
      for (var d = 0; d < days.length; d++) {
        var rngSynced = new CSRandom(
          getRandomSeed(
            getHashFromString("travelerSkillBook"),
            save.gameID,
            offset + days[d] + save.dayAdjust,
          ),
        );
  ...
  function predictKrobus(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      // so that it appears exactly as was typed in by the user.
      searchTerm = new RegExp(offset, "i");
      searchStart = $("#krobus-search-all").prop("checked")
        ? 0
        : 7 * Math.floor((save.daysPlayed - 1) / 7);
      ...
      output +=
        ...
        offset +
        "&quot; over the " +
        ($("#krobus-search-all").prop("checked") ? "first " : "next ") +
        $("#krobus-search-range").val() +
        " year(s)</th></tr>\n";
      output +=
        '<tr><th class="day">Day</th><th class="item">Item</th><th class="qty">Qty</th><th class="price">Price</th></tr>\n<tbody>';
      count = 0;
        ...
        for (var i = 0; i < days.length; i++) {
          if (compareSemVer(save.version, "1.6") >= 0) {
            ...
            if (days[i] === 3) {
              ...
              var rngSynced = new CSRandom(
                getRandomSeed(
                  getHashFromString("krobus_bread"),
                  offset + days[i] + save.dayAdjust,
                ),
              );
            ...
            rng = new CSRandom(
              save.gameID / 2 + offset + days[i] + save.dayAdjust,
            );
      ...
      dayOfMonth = offset % 28;
      output +=
        '<table class="output"><thead><tr><th colspan="3" class="multi">' +
        save.dayNames[2] +
        " " +
        monthName +
        " " +
      ...
      if (compareSemVer(save.version, "1.6") >= 0) {
        rng = new CSRandom(
          getRandomSeed(offset + 3 + save.dayAdjust, save.gameID / 2),
        );
        var result = getRandomItems(rng, "objects", 698, 708, true, true);
        item[0] = save.objects[result[0]].name;
        rng = new CSRandom(
          getRandomSeed(offset + 6 + save.dayAdjust, save.gameID / 2),
        );
        var rngSynced = new CSRandom(
          getRandomSeed(
            getHashFromString("krobus_bread"),
            offset + 6 + save.dayAdjust,
          ),
        );
        if (rngSynced.NextDouble() < 0.0196078431) {
  ...
  function predictSandy(isSearch, offset) {
    ...
    var ccShirts = [
      1019, 1022, 1023, 1040, 1041, 1043, 1045, 1046, 1049, 1054, 1056, 1060,
      1076, 1080, 1082, 1084, 1087, 1090, 1108, 1109, 1110,
    ];
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      // so that it appears exactly as was typed in by the user.
      searchTerm = new RegExp(offset, "i");
      searchStart = $("#sandy-search-all").prop("checked")
        ? 1
        : 7 * Math.floor((save.daysPlayed - 1) / 7);
      searchEnd = 112 * $("#sandy-search-range").val();
      output +=
        '<table class="output"><thead><tr><th colspan="3">Search results for &quot;' +
        offset +
        "&quot; over the " +
        ($("#sandy-search-all").prop("checked") ? "first " : "next ") +
        $("#sandy-search-range").val() +
        " year(s)</th></tr>\n";
      output +=
        '<tr><th class="day">Day</th><th class="shirt-item">Image</th><th class="item">Name</th></tr>\n<tbody>';
      count = 0;
      // Much of the logic here is duplicated from the browsing section, but comments related to it have been removed.
      console.log(
        "Searching from " + searchStart + " to " + (searchStart + searchEnd),
      );
      for (
        offset = searchStart;
        offset < searchStart + searchEnd;
        ...
        for (var i = 0; i < 7; i++) {
          ...
          if (compareSemVer(save.version, "1.6") >= 0) {
            ...
            item =
              save.shirts[result[0]].name +
              " (ID '(S)" +
              save.shirts[result[0]].id +
              "')";
          } else {
          ...
          if (searchTerm.test(item)) {
            ...
            if (oasisShirts.includes(numID)) {
              extra =
                '<br/><img src="blank.png" class="icon" id="no_sew"> <span class="note">Oasis exclusive</span>';
            } else if (ccShirts.includes(numID)) {
              extra =
                '<br/><img src="blank.png" class="icon" id="no_sew"> <span class="note">Character Creator option ' +
                spriteID +
                "</span>";
            }
            output +=
              ...
              year +
              "</td><td>" +
              '<img src="blank.png" class="shirt" id="shirt_' +
              spriteID +
              '"></td>' +
              '<td clas="shirt-name">' +
              item +
      ...
      output +=
        '<tr><td colspan="3" class="count">Found ' +
        count +
        " matching item(s)</td></tr>";
      output +=
        '<tr><td colspan="3" class="legend">Note: <img src="blank.png" class="icon" id="no_sew" alt="No Sewing"> denotes items which cannot be made via ' +
        wikify("Tailoring") +
        "</td></tr>";
      output += "</tbody></table>\n";
    } else {
  ...
  function predictGeodes(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      output +=
        ...
        offset +
        "&quot; over the " +
        ($("#geode-search-all").prop("checked") ? "first " : "next ") +
      ...
      if (compareSemVer(save.version, "1.4") >= 0) {
        output +=
          '<th class="geode-result">Artifact Trove <a href="https://stardewvalleywiki.com/Artifact_Trove">' +
          '<img src="blank.png" class="icon" id="geode_t"></a></th>';
      }
      if (compareSemVer(save.version, "1.5") >= 0) {
        output +=
          '<th class="geode-result">Golden Coconut <a href="https://stardewvalleywiki.com/Golden_Coconut">' +
      ...
      for (numCracked = searchStart; numCracked < searchEnd; numCracked++) {
        ...
        if (compareSemVer(save.version, "1.6") >= 0) {
          if (typeof save.mp_ids !== "undefined") {
            ...
            rngTrove = new CSRandom(
              getRandomSeed(numCracked, save.gameID / 2, 0),
            );
            $("#geode-note").html(
              "Note: No players found; predictions will not be reliable for game version >= 1.6",
            );
          }
        } else {
        ...
        if (compareSemVer(save.version, "1.4") >= 0) {
          ...
          item.push(
            save.objects[
              save.geodeContents[275][
                Math.floor(c * save.geodeContents[275].length)
              ]
            ].name,
          );
          itemQty.push(1);
        ...
        if (getGoodStuff) {
          ...
          item[0] =
            save.objects[
              save.geodeContents[535][
                Math.floor(next * save.geodeContents[535].length)
              ]
            ].name;
          item[1] =
            save.objects[
              save.geodeContents[536][
                Math.floor(next * save.geodeContents[536].length)
              ]
            ].name;
          item[2] =
            save.objects[
              save.geodeContents[537][
                Math.floor(next * save.geodeContents[537].length)
              ]
            ].name;
          if (compareSemVer(save.version, "1.6") >= 0) {
      ...
      Object.keys(searchResults)
        ...
        .forEach(function (key, index) {
          ...
          if (!save.donatedItems.hasOwnProperty(key)) {
            itemIcon =
              ' <span data-tooltip="Need to Donate"><img src="blank.png" class="icon" id="gunther" alt="Need to Donate"></span>';
          }
      ...
      output +=
        ...
        '" class="count">Found ' +
        count +
        " matching instance(s) of " +
        Object.keys(searchResults).length +
        " matching item(s)</td></tr>\n";
    } else {
      if (typeof offset === "undefined") {
        offset =
          pageSize * Math.floor(save.geodesCracked[whichPlayer] / pageSize);
      }
      if (offset < pageSize) {
        $("#geode-prev").prop("disabled", true);
      } else {
      ...
      output +=
        '<table class="output"><thead><tr><th rowspan="2" class="index">Num Open</th>' +
      ...
      if (compareSemVer(save.version, "1.4") >= 0) {
        output +=
          '<th colspan="2" class="multi"">Artifact Trove <a href="https://stardewvalleywiki.com/Artifact_Trove">' +
          '<img src="blank.png" class="icon" id="geode_t"></a></th>';
      }
      if (compareSemVer(save.version, "1.5") >= 0) {
        output +=
          '<th colspan="2" class="multi"">Golden Coconut <a href="https://stardewvalleywiki.com/Golden_Coconut">' +
          '<img src="blank.png" class="icon" id="geode_c"></a></th>';
      }
      output += "</tr>\n<tr>";
      for (c = 0; c < numColumns; c++) {
      ...
      for (g = 1; g <= pageSize; g++) {
        ...
        if (compareSemVer(save.version, "1.4") >= 0) {
          ...
          if (compareSemVer(save.version, "1.5") >= 0) {
            couldBeHat = c < 0.05;
            roll = Math.floor(
              rngTrove.NextDouble() * save.geodeContents[791].length,
            );
            qty = roll === 2 || roll == 3 || roll == 6 ? 5 : 1;
            item.push(save.objects[save.geodeContents[791][roll]].name);
            itemQty.push(qty);
        ...
        output +=
          '<tr class="' + tclass + '"><td>' + addCommas(numCracked) + "</td>";
        for (c = 0; c < numColumns; c++) {
          itemIcon = "";
          ...
          if (c === 5) {
            if (couldBeHat) {
              itemIcon =
                ' <span data-tooltip="Could be Golden Helmet"><img src="blank.png" class="icon" id="icon_h" alt="Could be Golden Helmet"></span>';
            }
            if (couldBeBeansTrove) {
              itemIcon +=
                ' <span data-tooltip="Could be Qi Beans"><img src="blank.png" class="icon" id="icon_b" alt="Could be Qi Beans"></span>';
            }
          } else {
    ...
    output +=
      ...
      "which need to be donated to the " +
      wikify("Museum") +
      '<br/> <img src="blank.png" class="icon" id="icon_b" alt="Could be Qi Beans"> denotes items which will be replaced by ' +
      wikify("Qi Beans") +
      ' and <img src="blank.png" class="icon" id="icon_h" alt="Could be Golden Coconut Hat"> denotes items which will be replaced by the ' +
      wikify("Golden Helmet") +
      " if applicable.</td></tr>";
    output += "</tbody></table>";
    return output;
  }
  ...
  function predictMysteryBoxes(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      searchStart = Math.max(
        1,
        $("#mystery-search-all").prop("checked")
          ? 1
          : save.mysteryBoxesOpened[whichPlayer],
      );
      ...
      output +=
        ...
        offset +
        "&quot; over the " +
        ($("#mystery-search-all").prop("checked") ? "first " : "next ") +
        $("#mystery-search-range").val() +
        " mystery boxes</th></tr>\n";
      output +=
        '<tr><th class="item">Item</th>' +
              ...
              switch (rng.Next(15)) {
                ...
                case 2:
                  ...
                  if (rng.NextDouble() < 0.5) {
                    ...
                    item[c] =
                      save.objects[choices[rng.Next(choices.length)]].name;
                    basedOnSkill[c] = true;
                  } else {
            ...
            switch (rng.Next(14)) {
              ...
              case 12:
                if (rng.NextDouble() < 0.4) {
                  switch (rng.Next(4)) {
                    case 0:
                      item[c] = save.objects["_525"].name;
                      break;
                    case 1:
                      item[c] = save.objects["_529"].name;
                      break;
                    case 2:
                      item[c] = save.objects["_888"].name;
                      break;
                    default:
                      item[c] = save.objects["_" + rng.Next(531, 533)].name;
                  }
                } else {
                  item[c] = "Mystery Box";
                  itemQty[c] = 2;
      ...
      Object.keys(searchResults)
        ...
        .forEach(function (key, index) {
          itemIcon =
            key == "Cork Bobber" || key == "Dressed Spinner"
              ? ' <span data-tooltip="Based on Fishing Skill"><img src="blank.png" class="icon" id="enchant_f" alt="Based on Fishing Skill"></span>'
              : "";
          output += '<tr><td class="item">' + wikify(key) + itemIcon + "</td>";
          for (c = 0; c < numColumns; c++) {
            if (searchResults[key][c].length > 0) {
      ...
      if (typeof offset === "undefined") {
        offset =
          pageSize *
          Math.floor(save.mysteryBoxesOpened[whichPlayer] / pageSize);
      }
      if (offset < pageSize) {
        $("#mystery-prev").prop("disabled", true);
      } else {
      ...
      for (g = 1; g <= pageSize; g++) {
        ...
        output +=
          '<tr class="' + tclass + '"><td>' + addCommas(numOpened) + "</td>";
        for (c = 0; c < numColumns; c++) {
          itemIcon = "";
          if (basedOnSkill[c]) {
            itemIcon =
    ...
    output +=
      '<tr><td colspan="' +
      (1 + 2 * numColumns) +
      '" class="legend">Note: <img src="blank.png" class="icon" id="enchant_f" alt="Based on Fishing Skill"> denotes items which will only roll if fishing skill is >= 6. If fishing skill is less, this result will instead be ' +
      wikify(save.objects["_242"].name) +
      " x2</td></tr>";
    output += "</tbody></table>";
    return output;
  }
  ...
  function predictNight(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      Object.keys(test).forEach(function (key, index) {
        if (test[key].s > 0 && test[key].q > 0) {
          console.log(
            "** Save id " +
              key +
              " has a giant seasonal on " +
              test[key].s +
              " and a giant qi on " +
              monthName +
              " " +
  ...
  function predictResortVisitors(isSearch, offset) {
    ...
    var output = "",
      ...
      groups = [
        ["Sebastian", "Sam", "Abigail"],
        ["Jodi", "Kent", "Vincent", "Sam"],
        ["Jodi", "Vincent", "Sam"],
        ...
        ["Penny", "Jas", "Vincent"],
        ["Pam", "Penny"],
        ["Caroline", "Marnie", "Robin", "Jodi"],
        ["Haley", "Penny", "Leah", "Emily", "Maru", "Abigail"],
        ["Alex", "Sam", "Sebastian", "Elliott", "Shane", "Harvey"],
      ],
      i,
      day,
      weekDay,
      ...
      for (weekDay = 1; weekDay < 8; weekDay++) {
        ...
        switch (day % 112) {
          ...
          case 39:
            ...
            break;
          case 56:
            festival = "Moonlight Jellies";
            break;
          case 72:
            festival = "Valley Fair";
            break;
          case 83:
          ...
          case 92:
            ...
            break;
          case 109:
            festival = "Winter Star";
            break;
        }

        if (festival !== "") {
          thisEvent =
            '<span class="none">Closed for<br/>' + festival + "</span>";
        } else {
  ...
  function predictEnchantments(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      if (typeof offset === "undefined") {
        offset =
          pageSize * Math.floor(save.timesEnchanted[whichPlayer] / pageSize);
      }
      if (offset < pageSize) {
      ...
      output +=
        '<table class="output"><thead><tr><th class="index">Num Ench.</th>' +
      ...
      for (g = 1; g <= pageSize; g++) {
          ...
          if (typeof save.mp_ids !== "undefined") {
            rng = new CSRandom(
              getRandomSeedFromBigInts(
                bigInt(timesEnchanted - 1),
                bigInt(save.gameID),
                save.mp_ids[whichPlayer],
              ),
            );
          } else {
            rng = new CSRandom(
              getRandomSeed(timesEnchanted - 1, save.gameID, 0),
            );
            $("#enchant-note").html(
              "Note: No players found; predictions will not be reliable for game version >= 1.6",
            );
        ...
        for (c = 0; c < numColumns; c++) {
          output +=
            ...
            "<br/>or " +
            item[c][2] +
            '<br/><span class="note" data-tooltip="' +
            tooltip[c] +
            '">(...)</span></td>';
        }
        output += "</tr>";
  ...
  function predictMineChests(isSearch, offset) {
    var output = "",
      ...
      choices = {
        ...
        20: [
          ...
          save.weapons[24],
          save.weapons[20],
          save.objects["_517"].name,
          save.objects["_519"].name,
        ],
        30: ["(No chest)"],
        40: [save.weapons[32]],
        50: [
    ...
    output +=
      '<table class="output"><thead><tr><th>Floor</th><th>Item in Chest</th></tr>';
    ...
    for (floor = 10; floor < 121; floor += 10) {
      ...
      if (compareSemVer(save.version, "1.6") >= 0) {
        rng = new CSRandom(
          getRandomSeedFromBigInts(
            bigInt(save.gameID).times(512),
            bigInt(floor),
          ),
        );
      } else {
        rng = new CSRandom(
          bigIntToSigned32(bigInt(save.gameID).times(512).plus(floor)),
        );
      }
  ...
  function predictGemBirds(isSearch, offset) {
    ...
    if (compareSemVer(save.version, "1.5") < 0) {
      $("#gembirds-note").html(
        "This is meaningless in pre-1.5 games since the Island and birds don't exist.",
      );
    } else {
      $("#gembirds-note").html("");
    }
    ...
    output +=
      '<table class="output"><thead><tr><th colspan>Direction (Location)</th><th>Bird Type</th></tr>';
  ...
  function predictWinterStar(isSearch, offset) {
    ...
    if (
      typeof save.names !== "undefined" &&
      typeof save.mp_ids !== "undefined"
    ) {
      ...
      forceOldLogic = true;
      $("#winterstar-note").html(
        "Note: No players found; predictions will not be reliable for game version > 1.2",
      );
    }

    output +=
      '<table class="output"><thead><tr><th colspan = "4">Year ' +
      year +
      "</th></tr>";
    output +=
      '<tr><th>Player</th><th>Player gives gift to</th><th>Player receives gift from</th><th class="long_list">Possible gifts received</th></tr></thead>\n<tbody>';
    for (player = 0; player < numPlayers; player++) {
      ...
      if (!forceOldLogic && compareSemVer(save.version, "1.6") >= 0) {
        ...
        while (
          excluded.hasOwnProperty(secretSantaGiveTo) ||
          (year === 1 && secretSantaGiveTo === "Kent")
        ) {
          secretSantaGiveTo = npcs[rng.Next(npcs.length)];
        }
        while (
          secretSantaGetFrom === "" ||
          secretSantaGetFrom === secretSantaGiveTo ||
          excluded.hasOwnProperty(secretSantaGetFrom) ||
      ...
      if (giftChoices.hasOwnProperty(secretSantaGetFrom)) {
        gifts = giftChoices[secretSantaGetFrom]
          .map(function (i) {
            return wikify(i);
          })
          .sort()
      ...
      output +=
        ...
        playerName +
        "</td><td>" +
        wikify(secretSantaGiveTo) +
        "</td><td>" +
        wikify(secretSantaGetFrom) +
        '</td><td class="long_list">' +
        gifts +
        "</td></tr>\n";
    }
    output += "</tbody></table>\n";
  ...
  function predictMakeover(isSearch, offset) {
    ...
    var output = "",
      ...
      makeoverChoices = {
        Male: [
          'Dark Ballcap<br/>Skeleton Shirt<br/>Tight Pants <span class="swatch" style="color:#dfd5b7">██</span>',
          "Dinosaur Hat<br/>Red Striped Shirt<br/>Dinosaur Pants",
          "Hair Bone<br/>Caveman Shirt<br/>Grass Skirt",
          'Santa Hat<br/>Fancy Red Blouse<br/>Shorts <span class="swatch" style="color:#8bff63">██</span>',
          'Cat Ears<br/>Short Jacket <span class="swatch" style="color:Red">██</span><br/>Genie Pants <span class="swatch" style="color:#e8d888">██</span>',
          'Goggles<br/>Circuitboard Shirt<br/>Baggy Pants <span class="swatch" style="color:#3c633e">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1089<br/>Farmer Pants <span class="swatch" style="color:#9658d3">██</span>',
          'Joja Cap<br/>Shirt – ID (S)1105<br/>Farmer Pants <span class="swatch" style="color:#2e55b7">██</span>',
          'Beanie<br/>Skull Shirt<br/>Farmer Pants <span class="swatch" style="color:#282828">██</span>',
          '(No Hat)<br/>Gray Suit<br/>Farmer Pants <span class="swatch" style="color:#989b92">██</span>',
          'Laurel Wreath Crown<br/>Toga Shirt<br/>Skirt <span class="swatch" style="color:#f7f5cd">██</span>',
          'Straw Hat<br/>Yellow Suit<br/>Farmer Pants <span class="swatch" style="color:#f2bd 2">██</span>',
          'Gnome\'s Cap<br/>Green Tunic<br/>Skirt <span class="swatch" style="color:#297216">██</span>',
          'Cowboy Hat<br/>Excavator Shirt<br/>Farmer Pants <span class="swatch" style="color:#a86f 1">██</span>',
          'Good Ol\' Cap<br/>Brown Overalls<br/>Farmer Pants <span class="swatch" style="color:#824e 1">██</span>',
          '(No Hat)<br/>Black Leather Jacket<br/>Baggy Pants <span class="swatch" style="color:#303030">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1099<br/>Farmer Pants <span class="swatch" style="color:#353535">██</span>',
          '(No Hat)<br/>Store Owner\'s Jacket<br/>Farmer Pants <span class="swatch" style="color:#25562a">██</span>',
          'Delicate Bow<br/>Shirt – ID (S)1092<br/>Skirt <span class="swatch" style="color:#f25769">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1088<br/>Shorts <span class="swatch" style="color:#63dd8d">██</span>',
          '(No Hat)<br/>Sailor Shirt<br/>Shorts <span class="swatch" style="color:#465aa3">██</span>',
          '(No Hat)<br/>Dark Shirt<br/>Tight Pants <span class="swatch" style="color:#515151">██</span>',
          'Totem Mask<br/>Fake Muscles Shirt <span class="swatch" style="color:#f9ae89">██</span><br/>Shorts <span class="swatch" style="color:#128c17">██</span>',
          '(No Hat)<br/>Crop Tank Top (M) <span class="swatch" style="color:#ffebcb">██</span><br/>Farmer Pants <span class="swatch" style="color:#683535">██</span>',
          '(No Hat)<br/>Basic Pullover (M) <span class="swatch" style="color:#ffc6 0">██</span><br/>Relaxed Fit Shorts <span class="swatch" style="color:#5997d1">██</span>',
          'Mouse Ears<br/>Shirt – ID (S)1066<br/>Shorts <span class="swatch" style="color:#b7a3a3">██</span>',
          'Propeller Hat<br/>Jester Shirt<br/>Farmer Pants <span class="swatch" style="color:# 2b8e0">██</span>',
          '(No Hat)<br/>Crab Cake Shirt<br/>Farmer Pants <span class="swatch" style="color:#bf2116">██</span>',
          'Sou\'wester<br/>Rain Coat<br/>Relaxed Fit Pants <span class="swatch" style="color:#ffa9 2">██</span>',
          '(No Hat)<br/>Camo Shirt<br/>Relaxed Fit Pants <span class="swatch" style="color:#6b3f17">██</span>',
          '(No Hat)<br/>Collared Shirt <span class="swatch" style="color:#63ccb9">██</span><br/>Farmer Pants <span class="swatch" style="color:#e2ac5a">██</span>',
          'Hard Hat<br/>Oil Stained Shirt<br/>Relaxed Fit Pants <span class="swatch" style="color:#638460">██</span>',
          'Party Hat<br/>Happy Shirt<br/>Farmer Pants <span class="swatch" style="color:#e21b1b">██</span>',
          '(No Hat)<br/>White Gi<br/>Simple Dress <span class="swatch" style="color:#fcd7ab">██</span>',
          '(No Hat)<br/>Trash Can Shirt<br/>Shorts <span class="swatch" style="color:#757575">██</span>',
          '(No Hat)<br/>Turtleneck Sweater <span class="swatch" style="color:#38c3ff">██</span><br/>Farmer Pants <span class="swatch" style="color:#632f18">██</span>',
          'Pageboy Cap<br/>Mayoral Suspenders<br/>Farmer Pants <span class="swatch" style="color:#702616">██</span>',
          '(No Hat)<br/>Retro Rainbow Shirt<br/>Farmer Pants <span class="swatch" style="color:#ad2b69">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1031<br/>Skirt <span class="swatch" style="color:#a5836a">██</span>',
          '(No Hat)<br/>Green Overalls<br/>Farmer Pants <span class="swatch" style="color:#3043e8">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1074<br/>Relaxed Fit Pants <span class="swatch" style="color:#ba 5 5">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1116<br/>Farmer Pants <span class="swatch" style="color:#ffb547">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1126<br/>Baggy Pants <span class="swatch" style="color:#6a36d8">██</span>',
          '(No Hat)<br/>Tunnelers Jersey<br/>Relaxed Fit Shorts <span class="swatch" style="color:#514b41">██</span>',
          'Official Cap<br/>Officer Uniform<br/>Farmer Pants <span class="swatch" style="color:#35345b">██</span>',
          '(No Hat)<br/>Dark Striped Shirt <span class="swatch" style="color:#ffffff">██</span><br/>Baggy Pants <span class="swatch" style="color:#333333">██</span>',
          '(No Hat)<br/>Basic Pullover (M) <span class="swatch" style="color:#9fff72">██</span><br/>Tight Pants <span class="swatch" style="color:#97ff72">██</span>',
        ],
        Female: [
          'Dark Ballcap<br/>Skeleton Shirt<br/>Tight Pants <span class="swatch" style="color:#dfd5b7">██</span>',
          "Dinosaur Hat<br/>Red Striped Shirt<br/>Dinosaur Pants",
          'Spotted Headscarf<br/>Classy Top (F)<br/>Dress <span class="swatch" style="color:#8e 1 1">██</span>',
          "Hair Bone<br/>Caveman Shirt<br/>Grass Skirt",
          'Santa Hat<br/>Fancy Red Blouse<br/>Shorts <span class="swatch" style="color:#8bff63">██</span>',
          'Cat Ears<br/>Short Jacket <span class="swatch" style="color:Red">██</span><br/>Genie Pants <span class="swatch" style="color:#e8d888">██</span>',
          'Goggles<br/>Circuitboard Shirt<br/>Baggy Pants <span class="swatch" style="color:#3c633e">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1089<br/>Farmer Pants <span class="swatch" style="color:#9658d3">██</span>',
          'Joja Cap<br/>Shirt – ID (S)1105<br/>Farmer Pants <span class="swatch" style="color:#2e55b7">██</span>',
          'Logo Cap<br/>Sugar Shirt<br/>Skirt <span class="swatch" style="color:#f9acba">██</span>',
          'Laurel Wreath Crown<br/>Toga Shirt<br/>Skirt <span class="swatch" style="color:#f7f5cd">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1072<br/>Simple Dress <span class="swatch" style="color:#698ec6">██</span>',
          'Daisy<br/>Shirt – ID (S)1118<br/>Skirt <span class="swatch" style="color:#5da4f7">██</span>',
          'Straw Hat<br/>Green Buttoned Vest <span class="swatch" style="color:Red">██</span><br/>Skirt <span class="swatch" style="color:#1e9647">██</span>',
          'Gnome\'s Cap<br/>Green Tunic<br/>Skirt <span class="swatch" style="color:#297216">██</span>',
          'Cowboy Hat<br/>Excavator Shirt<br/>Farmer Pants <span class="swatch" style="color:#a86f 1">██</span>',
          'Good Ol\' Cap<br/>Brown Overalls<br/>Farmer Pants <span class="swatch" style="color:#824e 1">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1099<br/>Farmer Pants <span class="swatch" style="color:#353535">██</span>',
          '(No Hat)<br/>Store Owner\'s Jacket<br/>Farmer Pants <span class="swatch" style="color:#25562a">██</span>',
          'Watermelon Band<br/>Shirt – ID (S)1106<br/>Skirt <span class="swatch" style="color:#53d1ab">██</span>',
          'Delicate Bow<br/>Shirt – ID (S)1092<br/>Skirt <span class="swatch" style="color:#f25769">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1088<br/>Shorts <span class="swatch" style="color:#63dd8d">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1103<br/>Skirt <span class="swatch" style="color:#35373a">██</span>',
          '(No Hat)<br/>Sailor Shirt<br/>Shorts <span class="swatch" style="color:#465aa3">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1050<br/>Pleated Skirt <span class="swatch" style="color:#fc9298">██</span>',
          '(No Hat)<br/>Crop Tank Top (M) <span class="swatch" style="color:#ffebcb">██</span><br/>Farmer Pants <span class="swatch" style="color:#683535">██</span>',
          '(No Hat)<br/>Basic Pullover (M) <span class="swatch" style="color:#ffc6 0">██</span><br/>Relaxed Fit Shorts <span class="swatch" style="color:#5997d1">██</span>',
          '(No Hat)<br/>High-Waisted Shirt <span class="swatch" style="color:#1da362">██</span><br/>Pleated Skirt <span class="swatch" style="color:#1da362">██</span>',
          '(No Hat)<br/>Tube Top <span class="swatch" style="color:#97ff72">██</span><br/>Tight Pants <span class="swatch" style="color:#97ff72">██</span>',
          'Mouse Ears<br/>Shirt – ID (S)1066<br/>Shorts <span class="swatch" style="color:#b7a3a3">██</span>',
          '(No Hat)<br/>Slime Shirt<br/>Simple Dress <span class="swatch" style="color:#39cc2c">██</span>',
          'Propeller Hat<br/>Jester Shirt<br/>Farmer Pants <span class="swatch" style="color:# 2b8e0">██</span>',
          '(No Hat)<br/>Crab Cake Shirt<br/>Farmer Pants <span class="swatch" style="color:#bf2116">██</span>',
          'Sou\'wester<br/>Rain Coat<br/>Relaxed Fit Pants <span class="swatch" style="color:#ffa9 2">██</span>',
          '(No Hat)<br/>Camo Shirt<br/>Relaxed Fit Pants <span class="swatch" style="color:#6b3f17">██</span>',
          '(No Hat)<br/>Sailor Shirt <span class="swatch" style="color:#d13e3e">██</span><br/>Pleated Skirt <span class="swatch" style="color:#d13e3e">██</span>',
          '(No Hat)<br/>White Gi<br/>Simple Dress <span class="swatch" style="color:#fcd7ab">██</span>',
          '(No Hat)<br/>Trash Can Shirt<br/>Shorts <span class="swatch" style="color:#757575">██</span>',
          '(No Hat)<br/>Turtleneck Sweater <span class="swatch" style="color:#38c3ff">██</span><br/>Farmer Pants <span class="swatch" style="color:#632f18">██</span>',
          'Pageboy Cap<br/>Mayoral Suspenders<br/>Farmer Pants <span class="swatch" style="color:#702616">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1086<br/>Dress <span class="swatch" style="color:#964361">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1031<br/>Skirt <span class="swatch" style="color:#a5836a">██</span>',
          '(No Hat)<br/>Green Overalls<br/>Farmer Pants <span class="swatch" style="color:#3043e8">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1074<br/>Relaxed Fit Pants <span class="swatch" style="color:#ba 5 5">██</span>',
          '(No Hat)<br/>Shirt – ID (S)1051<br/>Relaxed Fit Shorts <span class="swatch" style="color:#dd4457">██</span>',
          '(No Hat)<br/>Tunnelers Jersey<br/>Relaxed Fit Shorts <span class="swatch" style="color:#514b41">██</span>',
          'Official Cap<br/>Officer Uniform<br/>Farmer Pants <span class="swatch" style="color:#35345b">██</span>',
          '(No Hat)<br/>Dark Striped Shirt <span class="swatch" style="color:#ffffff">██</span><br/>Baggy Pants <span class="swatch" style="color:#333333">██</span>',
        ],
    ...
    output +=
      ...
      "</th></tr>";
    output +=
      "<tr><th> </th><th>Monday Spring 15</th><th>Tuesday Spring 16</th><th>Wednesday Spring 17</th></tr></thead>\n<tbody>";
    ...
    for (var d = 0; d < 3; d++) {
      ...
      for (var c = 0; c < save.characters.length; c++) {
        if (!possibleVendors.hasOwnProperty(save.characters[c])) {
          continue;
        }
        if (save.characters[c] === "Kent" && year < 2) {
          continue;
        }
        if (save.characters[c] === "Leo" && !save.leoMoved) {
          continue;
        }
        if (scheduleExclusion[d].hasOwnProperty(save.characters[c])) {
          continue;
        }
    ...
    if (typeof save.mp_ids !== "undefined" && save.mp_ids.length > 0) {
      ...
      if (save.gender[0] === "") {
        ...
        $("#makeover-note").html(
          "Warning: Predictor could not determing player gender. All players will be assumed to be female. To get better makeover predictions, use a game saved under current version.",
        );
      }
      ...
      for (player = 0; player < save.mp_ids.length; player++) {
        ...
        output +=
          '<tr class="' +
          tclass +
          '"><td>Free "Cactis" for<br/>' +
          save.names[player] +
          "</td>";
        var parts = [rng.Next(24), rng.Next(24), rng.Next(16)];
        output +=
          '<td colspan="3"><img src="blank.png" class="cactis" id="c_top_' +
          parts[0] +
          '" alt="Cactis Top"><br/>';
        output +=
          '<img src="blank.png" class="cactis" id="c_mid_' +
          parts[1] +
          '" alt="Cactis Top"><br/>';
        output +=
          '<img src="blank.png" class="cactis" id="c_bot_' +
          parts[2] +
          '" alt="Cactis Top"></td></tr>';
      }
      for (player = 0; player < save.mp_ids.length; player++) {
        var outfit = {};
        for (var d = 0; d < 3; d++) {
          ...
          roll = rng.NextDouble();
          outfit[d] =
            makeoverChoices[save.gender[player]][
              Math.floor(roll * makeoverChoices[save.gender[player]].length)
            ];
          if (d === 1) {
            rng = new CSRandom(getRandomSeed(day, save.gameID / 2));
      ...
      $("#makeover-note").html(
        "Note: No players found; vendor predictions will probably not be reliable, cactis predictions cannot be made, and makeover predictions can only show generic results",
      );
      output +=
        '<tr class="' +
        tclass +
        '"><td>Free "Cactis"</td><td colspan="3">Cannot predict; no players found</td></tr>';
      var outfit = [[], []];
      for (var d = 0; d < 3; d++) {
        day = 112 * offset + 15 + d;
        rng = new CSRandom(getRandomSeed(day, save.gameID / 2, year));
        ...
        roll = rng.NextDouble();
        outfit[0][d] =
          makeoverChoices.Female[
            Math.floor(roll * makeoverChoices.Female.length)
          ];
        outfit[1][d] =
          makeoverChoices.Male[Math.floor(roll * makeoverChoices.Male.length)];
        if (d === 1) {
          rng = new CSRandom(getRandomSeed(day, save.gameID / 2));
          if (rng.NextDouble() < 0.03) {
            outfit[0][d] =
      ...
      output +=
        '<tr class="' +
        tclass +
        '"><td>Makeover Outfit for<br/>Generic Female Player</td>';
      for (var d = 0; d < 3; d++) {
        output += "<td>" + outfit[0][d] + "</td>";
      }
      output += "</tr>";
      output +=
        '<tr class="' +
        tclass +
        '"><td>Makeover Outfit for<br/>Generic Male Player</td>';
      for (var d = 0; d < 3; d++) {
        output += "<td>" + outfit[1][d] + "</td>";
      }
      output += "</tr>";
    }
    output += "</tbody></table>\n";
  ...
  function predictGreenRain(isSearch, offset) {
        ...
        if (day == 1 || day == 2 || day == 4 || day % 28 == 1) {
          ...
          switch (season) {
            ...
            case 2:
              rng = new CSRandom(
                getRandomSeed(
                  getHashFromString("location_weather"),
                  save.gameID,
                  day - 1,
                ),
              );
    ...
    output +=
      '<tr><td colspan="7" class="legend"><img src="blank.png" class="icon" alt="Umbrella in rain" id="w_rain"> Rainy weather. "Rain" could become Storm.<br/><img src="blank.png" class="icon" alt="Shining Sun" id="w_sun"> Clear weather. "Sun" could become Wind or Snow.</td></tr>';
    output += "</tbody></table>\n";
  ...
  function predictCalicoJack(isSearch, offset, gameOffset = 0) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      output +=
        '<table class="output"><thead><tr><th class="index" rowspan="2">Game<br/>Count</th>' +
        '<th class="cj-result" colspan="2">' +
        save.dayNames[dayOfWeek] +
        " " +
        monthName +
        " " +
        dayOfMonth +
        ...
        "</th></tr>";
      output +=
        "<tr><th>Starting Hand</th><th>Best Strategy</th></tr></thead><tbody>";
      for (g = 1; g <= pageSize; g++) {
        ...
        while (playerTotal < 21) {
          ...
          if (distance > 1 && distance < 6 && roll[r++] < 1 / distance) {
            next = roll[r++] < 0.5 ? distance : distance - 1;
          }
          playerTotal += next;
        }
        if (playerTotal === 21) {
          ...
          for (var i = 0; i < choice.length; i++) {
            ...
            while (dealerTotal < 18 || dealerTotal < playerTotal) {
              ...
              var chance = Math.max(
                0.0005,
                0.001 + save.dailyLuck / 20 + save.luckLevel * 0.002,
              );
              var sbRoll = roll[r++];
              if (sbRoll < minRoll) {
                next = 999;
        ...
        output +=
          '<tr class="' + tclass + '"><td>' + addCommas(numPlayed) + "</td>";
  ...
  function predictBookseller(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      var searchStart = $("#book-search-all").prop("checked")
        ? 0
        : 7 * Math.floor((save.daysPlayed - 1) / 7);
      ...
      output +=
        ...
        offset +
        "&quot; over the " +
        ($("#book-search-all").prop("checked") ? "first " : "next ") +
        $("#book-search-range").val() +
        " year(s)</th></tr>\n";
      output +=
        '<tr><th class="day">Day</th><th class="item">Item</th><th class="price">Price</th></tr>\n<tbody>';
      var count = 0;
      for (
        offset = searchStart;
        offset < searchStart + searchEnd;
        ...
        var year = 1 + Math.floor(offset / 112);
        var rng = new CSRandom(
          getRandomSeed(year * 11, save.gameID, seasonIndex),
        );
        var possibleDays = [];
        switch (seasonIndex) {
          case 0:
            possibleDays = [11, 12, 21, 22, 25];
            break;
          case 1:
            possibleDays = [9, 12, 18, 25, 27];
            break;
          case 2:
            possibleDays = [4, 7, 8, 9, 12, 19, 22, 25];
            break;
          case 3:
            possibleDays = [5, 11, 12, 19, 22, 24];
            break;
        }
        ...
        var days = [
          possibleDays[i],
          possibleDays[
            Math.floor((i + possibleDays.length / 2) % possibleDays.length)
          ],
        ];
        ...
        for (var d = 0; d < days.length; d++) {
          ...
          var dateString =
            dayOfWeek + " " + monthName + " " + days[d] + ", Year " + year;
          rng = new CSRandom(getRandomSeed(daysPlayed, save.gameID / 2));
          var picked;
          var rngSynced = new CSRandom(
            getRandomSeed(
              getHashFromString("purplebookSale"),
              save.gameID,
              daysPlayed,
            ),
          );
          if (
            searchTerm.test("Book Of Stars") &&
            rngSynced.NextDouble() < 0.25
          ) {
            count++;
            output +=
              "<tr><td>" +
              dateString +
              '</td><td class="book">' +
              wikify("Book Of Stars") +
              "</td><td>15,000g</td></tr>";
          }
          var booksLeft = skillBookList.slice();
          rngSynced = new CSRandom(
            getRandomSeed(
              getHashFromString("thirdBookSale"),
              save.gameID,
              daysPlayed,
            ),
          );
          ...
          rngSynced = new CSRandom(
            getRandomSeed(
              getHashFromString("secondBookSale"),
              save.gameID,
              daysPlayed,
            ),
          );
          ...
          var rngSynced = new CSRandom(
            getRandomSeed(
              getHashFromString("bookExtraForaging"),
              save.gameID,
              daysPlayed,
            ),
          );
          if (
            searchTerm.test("Woodcutter's Weekly") &&
            rngSynced.NextDouble() < 0.33
          ) {
            count++;
            output +=
              "<tr><td>" +
      ...
      output +=
        '<table class="output"><thead><tr><th rowspan="2">Bookseller<br/>Items</th>';
      for (var d = 0; d < days.length; d++) {
        output +=
          '<th colspan="2" class="multi">' +
          save.dayNames[(6 + days[d]) % 7] +
          " " +
          monthName +
          " " +
          days[d] +
      ...
      for (var d = 0; d < days.length; d++) {
        ...
        if (rngSynced.NextDouble() < 0.6) {
          picked = booksLeft.splice(rng.Next(booksLeft.length), 1);
          stock[d].skill60pct =
            '<td class="book">' + wikify(picked[0]) + "</td><td>10,000g</td>";
        } else {
        ...
        if (rngSynced.NextDouble() < 0.8) {
          picked = booksLeft.splice(rng.Next(booksLeft.length), 1);
          stock[d].skill80pct =
            '<td class="book">' + wikify(picked[0]) + "</td><td>8,000g</td>";
        } else {
          stock[d].skill80pct = "<td>--</td><td>--</td>";
        }
        picked = booksLeft.splice(rng.Next(booksLeft.length), 1);
        stock[d].skillAlways =
          '<td class="book">' + wikify(picked[0]) + "</td><td>5,000g</td>";
        if (year >= 3) {
          picked = randBookList[rng.Next(randBookList.length)];
          stock[d].y3 =
            '<td class="book">' + wikify(picked) + "</td><td>20,000g</td>";
        } else {
    ...
    for (var week = 0; week < 4; week++) {
      ...
      for (var weekDay = 1; weekDay < 8; weekDay++) {
          ...
          if (save.hasOwnProperty("mp_ids")) {
            for (var player = 0; player < save.mp_ids.length; player++) {
              ...
              pbExtra +=
                ...
                " - " +
                pbMaps[index] +
                (shard ? " (prismatic shard expected)" : "") +
                "\n";
              console.log(
                "Butterfly coordinate possibilities for " +
                  save.names[player] +
                  " - " +
                  pbMaps[index] +
                  " on " +
              ...
              for (var i = 0; i <= 32; i++) {
                coords.push({
                  x: rng.Next(mapDim[index][0]),
                  y: rng.Next(mapDim[index][1]),
                });
              }
              console.log(coords);
            }
        ...
        output +=
          ...
          (day - offset) +
          "</span><br/>" +
          '<span class="cell"><img src="blank.png" class="icon" alt="Umbrella in rain" id="bless_r"> ' +
          rainText +
          '<br/><img src="blank.png" class="icon" alt="Shining Sun" id="bless_nr"> ' +
          noRainText +
          '<hr /><img src="blank.png" class="icon" alt="Dwarf 1" id="bless_d1"> ' +
          dwarf1Text +
          '<br/><img src="blank.png" class="icon" alt="Dwarf 2" id="bless_d2"> ' +
          dwarf2Text +
          "</span></td>";
      }
      output += "</tr>\n";
  ...
  function predictPrizeTicket(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      var searchStart = Math.max(
        1,
        $("#prize-search-all").prop("checked") ? 1 : save.mysteryBoxesOpened[0],
      );
      ...
      output +=
        ...
        offset +
        "&quot; over the " +
        ($("#prize-search-all").prop("checked") ? "first " : "next ") +
        $("#prize-search-range").val() +
        " prize claims</th></tr>\n";
      output +=
        '<tr><th class="item">Item</th><th class="mystery-result">Prize Received</th></tr><tbody>';
      var count = 0;
      var searchResults = {};
      // no searching yet.
      /*
      ...
      if (typeof offset === "undefined") {
        offset =
          pageSize *
          Math.floor(save.ticketPrizesClaimed[whichPlayer] / pageSize);
      }
      if (offset < pageSize) {
        $("#prize-prev").prop("disabled", true);
      } else {
      ...
      output +=
        '</tr><tr><th class="item">Item</th><th class="qty">Qty</th></tr><tbody>';
      var rng;
      if (typeof save.mp_ids !== "undefined") {
        rng = new CSRandom(
          getRandomSeedFromBigInts(
        ...
        $("#prize-note").html(
          "Note: No players found; predictions will not be reliable",
        );
      }
      ...
      for (var g = 1; g <= pageSize; g++) {
        ...
        switch (prizeLevel) {
          case 0:
            ...
            break;
          case 1:
            item = randRoll < 0.5 ? "Peach Sapling" : "Orange Sapling";
            break;
          case 2:
            if (randRoll < 0.5) {
              item = "Mixed Seeds";
          ...
          case 4:
            ...
            break;
          case 5:
            item = wikify("Blue Pinstripe Bed", "Furniture");
            noLink = true;
            break;
          case 6:
            ...
            break;
          case 7:
            item = randRoll < 0.5 ? "Apple Sapling" : "Pomegranate Sapling";
            break;
          case 8:
            item = '<span class="book">' + wikify("Friendship 101") + "</span>";
            noLink = true;
            break;
          case 9:
            switch (Math.floor(3 * randRoll)) {
            ...
            break;
          case 10:
            item = wikify("Sports Cap", "Hats");
            noLink = true;
            break;
          case 11:
            item = randRoll < 0.5 ? "Fish Smoker" : "Dehydrator";
            break;
          case 12:
            item = randRoll < 0.5 ? "Artifact Trove" : "Mystery Box";
            itemQty = 4;
            break;
          case 13:
            var choice = [
            ...
            item = wikify(
              choice[Math.floor(randRoll * choice.length)],
              "Furniture",
            );
            noLink = true;
            break;
          case 14:
            ...
            item =
              '<span class="book">' +
              wikify(choice[Math.floor(randRoll * choice.length)]) +
              "</span>";
            noLink = true;
            break;
          case 16:
            item = wikify("Cow Decal", "Furniture");
            noLink = true;
            break;
          case 17:
            item = "Omni Geode";
            ...
            break;
          case 18:
            item = randRoll < 0.5 ? "Bee House" : "Keg";
            itemQty = 4;
            break;
          case 19:
            item = "Diamond";
          ...
          case 21:
            ...
            break;
          default: {
            var rng2 = new CSRandom(
              getRandomSeed(save.gameID, prizeLevel - (prizeLevel % 9)),
            );
            switch (prizeLevel % 9) {
              case 0:
                item = "Mystery Box";
  ...
  function predictRaccoon(isSearch, offset) {
    ...
    if (isSearch && typeof offset !== "undefined" && offset !== "") {
      ...
      var searchStart = Math.max(
        1,
        $("#raccoon-search-all").prop("checked")
          ? 1
          : save.mysteryBoxesOpened[0],
      );
      ...
      output +=
        ...
        offset +
        "&quot; over the " +
        ($("#raccoon-search-all").prop("checked") ? "first " : "next ") +
        $("#raccoon-search-range").val() +
        " raccoon requests</th></tr>";
      output += "<tbody>";
      var count = 0;
      var searchResults = {};
      output +=
        '<tr><td colspan="2" class="count">Found ' +
        count +
        " matching instance(s) of " +
        Object.keys(searchResults).length +
        " matching item(s)</td></tr></tbody></table>";
      ...
      output +=
        '<table class="output"><thead><tr><th rowspan="2" class="index">Times Fed</th>' +
      ...
      output +=
        '</tr><tr><th class="item">Item</th><th class="qty">Qty</th><th class="item">Item</th><th class="qty">Qty</th><th class="item">Item</th><th class="qty">Qty</th></tr><tbody>';
      ...
      for (var g = 1; g <= pageSize; g++) {
        ...
        switch (whichBundle) {
          case 0:
            ...
            bundleItem[0] = wikify(
              save.objects[choice[rng[0].Next(choice.length)]].name,
            );
            for (var s = 1; s < 4; s++) {
              rng[s].Next();
            }
            ...
            for (var s = 0; s < 4; s++) {
              ...
              bundleItem[1][s] = wikify(
                "Smoked " + save.objects[choice[s][index]].name,
              );
            }
            break;
          case 1:
            ...
            for (var s = 0; s < 4; s++) {
              index = rng[s].Next(choice[s].length);
              bundleItem[0][s] = wikify(
                "Dried " + save.objects[choice[s][index]].name,
              );
              prevRoll[s] = index;
            }
            isLong[1] = true;
            ...
            for (var s = 0; s < 4; s++) {
              ...
              bundleItem[1][s] = wikify(
                save.objects[choice[s][index]].name + " Jelly",
              );
            }
            break;
          case 2:
          ...
          case 3:
            ...
            for (var s = 0; s < 4; s++) {
              index = rng[s].Next(choice[s].length);
              bundleItem[0][s] = wikify(
                save.objects[choice[s][index]].name + " Juice",
              );
              prevRoll[s] = index;
            }
            isLong[1] = true;
            ...
            for (var s = 0; s < 4; s++) {
              ...
              bundleItem[1][s] = wikify(
                "Pickled " + save.objects[choice[s][index]].name,
              );
            }
            break;
          case 4:
        ...
        switch (tableRow) {
          case 1:
            bundleItem[2] = "Raccoon Seeds";
            bundleQty[2] = 25;
            break;
          case 2:
            bundleItem[2] =
              '<span class="book">' + wikify("Raccoon Journal") + "</span>";
            break;
          case 3:
            bundleItem[2] = wikify("Raccoon Hat", "Hats");
            break;
          case 4:
            bundleItem[2] = wikify("Fairy Dust");
            bundleQty[2] = 7;
            break;
          case 5:
            bundleItem[2] = wikify("Jungle Tank", "Furniture");
            break;
          default: {
            ...
            switch (rng.Next(5)) {
              ...
              case 1:
                bundleItem[2] =
                  '<span class="book">' + wikify("Book Of Stars") + "</span>";
                break;
              case 2:
                bundleItem[2] =
                  "Next unshipped item<br/>OR<br/>" + wikify("Mystery Box");
                bundleQty[2] = "1<br/>OR<br/>5";
                break;
              case 3:
                bundleItem[2] = wikify("Stardrop Tea");
                break;
              case 4:
                bundleItem[2] = "Raccoon Seeds";
                bundleQty[2] = 25;
                break;
              default:
                bundleItem[2] = wikify("Mystery Box");
                bundleQty[2] = 3;
                break;
            }
          }
        ...
        output +=
          '<tr class="' + tclass + '"><td>' + addCommas(tableRow) + "</td>";
        ...
        for (var i = 0; i < 3; i++) {
          if (isLong[i]) {
            if (
              bundleItem[i][0] === bundleItem[i][1] &&
              bundleItem[i][0] === bundleItem[i][2] &&
              bundleItem[i][0] === bundleItem[i][3]
            ) {
              output +=
                '<td class="item">' +
                bundleItem[i][0] +
              ...
              for (var s = 0; s < 4; s++) {
                output +=
                  '<img src="blank.png" class="season" id="sea_' +
                  s +
                  '" alt="' +
                  save.seasonNames[s] +
                  '"> ' +
  ...
  function initializeHandlers() {
    $("button[class='browse']").click(function () {
      buttonHandler(this);
    });
    ...
    $("select[class='player']").change(function () {
      selectHandler(this);
    });
